...
import subprocess
import os, yaml
from RElectDGen.scripts.gpaw_MD_db import check_dft_steps
...
def main(args=None):
    ...
    for shell_file in filenames:
        ...
        if 'gpaw_MD' in shell_file and check_dft_steps(config)>0:
            ...
            shell_file = os.path.join(location,'train_array.sh')
